...
| 버전 | 상태 | 설명 |
|------|------|------|
| **[v1.0](specification/v1.0-a2ui.md)** | **후보(Candidate)** | 릴리스 후보입니다. 클라이언트-서버 RPC(`actionResponse`)와 액션 ID를 추가하고, theme을 surfaceProperties로 이름을 변경합니다. (초안 단계에서는 v0.10으로 지정되었습니다.) [진화 가이드 →](specification/v1.0-evolution-guide.md) |
| **[v0.9.1](specification/v0.9.1-a2ui.md)** | **현재(Current)** | 현재 프로덕션 릴리스입니다. v0.9에 대한 소규모 개선으로, `application/a2ui+json` MIME 타입을 표준화하고 surfaceId 제약을 완화합니다. [진화 가이드 →](specification/v0.9.1-evolution-guide.md) |
| **[v0.9](specification/v0.9-a2ui.md)** | **이전 안정판(Previous Stable)** | 이전 안정 버전입니다. Prompt-First로의 철학적 전환입니다. `createSurface`, 클라이언트 측 함수, 커스텀 카탈로그, 모듈형 스키마, validation failed 오류 포맷을 도입합니다. [진화 가이드 →](specification/v0.9-evolution-guide.md) |
| **[v0.8](specification/v0.8-a2ui.md)** | **레거시(Legacy)** | 레거시 버전입니다. Structured Output 우선 방식입니다. 기본 서피스, 컴포넌트, 데이터 바인딩, 인접 리스트 모델을 포함합니다. |

A2UI는 Apache 2.0 라이선스로 제공되며, Google이 [CopilotKit](https://docs.copilotkit.ai/generative-ui/a2ui)과 오픈 소스 커뮤니티의 기여를 받아 만들었고, [GitHub](https://github.com/a2ui-project/a2ui)에서 활발히 개발 중입니다.
...
- [A2UI 명세](specification/v0.9.1-a2ui.md) (v0.9.1 현재, v1.0 후보)
...
- :material-file-document:{ .lg .middle } **프로토콜 사양**
    ...
    전체 기술 사양과 메시지 유형을 확인해 보세요. [v0.8(레거시)](specification/v0.8-a2ui.md) · [v0.9(안정판)](specification/v0.9-a2ui.md) · [v0.9.1(현재)](specification/v0.9.1-a2ui.md) · [v1.0(후보)](specification/v1.0-a2ui.md)

    [:octicons-arrow-right-24: v0.9.1 명세 읽기](specification/v0.9.1-a2ui.md)
...
공개된 [A2UI Composer](https://a2ui-project.github.io/composer/)를 제공하고 있습니다.

[A2UI Composer 문서](./composer/index.md)
