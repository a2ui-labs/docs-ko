...
| 버전 | 상태 | 참고 사항 |
|---------|--------|-------|
| **v0.8** | 🆗 이전(Prior) | 초기 공개 릴리스, 최소 지원 |
| **v0.9** | 🆗 이전(Prior) | 기능 완성, 레거시 지원 |
| **v0.9.1** | 🆗 현재(Current) | 안정 릴리스 |
| **v1.0** | 📋 후보(Candidate) | 릴리스 후보 |
...
| [**Lynx**](https://lynxjs.org/next/react/genui/a2ui.html) | ✅ 안정(Stable) | 모바일, 웹, 데스크톱 | A2UI v0.9용 ReactLynx 렌더러 |
...
| **ADK** | 📋 계획됨 | 개발자 사용성 설계 중, [샘플](https://github.com/a2ui-project/a2ui/tree/main/samples/agent/adk) 참조 |
| **Genkit** | 💡 제안됨 | 커뮤니티 관심사 |
...
- [GitHub Discussions](https://github.com/a2ui-project/a2ui/discussions)에서 **기능을 제안**하세요.
- **프로토타입을 제작**하고 커뮤니티와 공유하세요.
- GitHub Issues에서 **대화에 참여**하세요.

## 최신 소식 받기

- 업데이트를 확인하려면 [GitHub 저장소](https://github.com/a2ui-project/a2ui)를 Watch 하세요.
...
로드맵에 대해 궁금한 점이 있으신가요? [GitHub에서 토론을 시작해 보세요](https://github.com/a2ui-project/a2ui/discussions).
