...
이 샘플을 실행하는 자세한 방법은 [README.md](https://github.com/a2ui-project/a2ui/blob/main/samples/community/mcp/a2ui-in-mcpapps/README.md)를 참고하세요.
...
5.  **Response**: MCP Server가 tool을 실행하고 `application/a2ui+json` resource가 포함된 result를 반환합니다.
...
3.  Host에서 응답을 받으면 content 안의 `application/a2ui+json` mimeType을 찾습니다.
4.  JSON text를 파싱하고 A2UI [`MessageProcessor`](https://github.com/a2ui-project/a2ui/blob/main/renderers/angular/src/v0_8/data/processor.ts)에 전달합니다.
