...
- **[server_to_client.json](https://github.com/a2ui-project/a2ui/blob/main/specification/0.8/json/server_to_client.json)**: 메시지 엔벨로프(envelope) 스키마
- **[standard_catalog_definition.json](https://github.com/a2ui-project/a2ui/blob/main/specification/0.8/json/standard_catalog_definition.json)**: 컴포넌트 스키마
