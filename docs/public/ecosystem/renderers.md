...
**BBC6BAE9/a2ui-swift**(이전 이름 **a2ui-swiftui**)는 iOS, macOS, visionOS, watchOS, tvOS를 지원하는 네이티브 SwiftUI 렌더러입니다. 18개의 기본 A2UI 컴포넌트를 모두 지원하며 v0.8과 v0.9 프로토콜을 동시에 지원합니다. JSONL 스트리밍을 포함하며, 반응성을 위해 Observation 프레임워크를 사용합니다.
