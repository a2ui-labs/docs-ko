...
| 렌더러 | 플랫폼 | v0.8 | v0.9 | 링크 |
|----------|----------|------|------|------|
| **React** | 웹 | ✅ 안정판 | ❌ | [코드](https://github.com/google/A2UI/tree/main/renderers/react) |
| **Lit(Web Components)** | 웹 | ✅ 안정판 | ✅ 안정판 | [코드](https://github.com/google/A2UI/tree/main/renderers/lit) |
| **Angular** | 웹 | ✅ 안정판 | ✅ 안정판 | [코드](https://github.com/google/A2UI/tree/main/renderers/angular) |
| **Flutter(GenUI SDK)** | 모바일/데스크톱/웹 | ✅ 안정판 | ✅ 안정판 | [문서](https://docs.flutter.dev/ai/genui) · [코드](https://github.com/flutter/genui) |
| **SwiftUI** | iOS/macOS | - | 🚧 예정(Q2) | - |
| **Jetpack Compose** | Android | - | 🚧 예정(Q2) | - |
