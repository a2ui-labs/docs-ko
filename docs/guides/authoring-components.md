...
[`rizzcharts`](../../samples/agent/adk/rizzcharts/python/README.md) 예시에서는 카탈로그 스키마가 [`rizzcharts_catalog_definition.json`](../../samples/agent/adk/rizzcharts/catalog_schemas/0.9/rizzcharts_catalog_definition.json)에 정의되어 있습니다.
...
[`rizzcharts`](../../samples/client/angular/projects/rizzcharts/README.md) 예시에서 `Chart` 컴포넌트는 [`chart.ts`](../../samples/client/angular/projects/rizzcharts/src/a2ui-catalog/chart.ts)에 정의되어 있습니다.
...
[`rizzcharts`](../../samples/agent/adk/rizzcharts/python/README.md) 예시에서는 [`catalog.ts`](../../samples/client/angular/projects/rizzcharts/src/a2ui-catalog/catalog.ts)에서 이 작업을 수행합니다.
...
Agent는 [SendA2uiToClientToolset](../../agent_sdks/python/src/a2ui/adk/send_a2ui_to_client_toolset.py)을 사용해 A2UI를 클라이언트로 보낼 수 있는 도구를 에이전트에 제공합니다.
...
LLM이 [SendA2uiToClientToolset](../../agent_sdks/python/src/a2ui/adk/send_a2ui_to_client_toolset.py)의 도구를 호출하면, A2A Agent Executor에서 [A2uiEventConverter](../../agent_sdks/python/src/a2ui/adk/send_a2ui_to_client_toolset.py)를 통해 이를 가로챕니다. 이 변환기는 도구 호출을 A2UI payload가 포함된 A2A Datapart로 자동 변환합니다.
